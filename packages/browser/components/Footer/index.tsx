...
const Footer: FC = () => (
  <footer className="bg-neutral-900 w-full">
    <div className="w-full flex p-10 px-24 border-b-4 border-blue-300 flex-col space-y-5 md:space-y-0 justify-between md:flex-row">
      <div className="flex space-x-4 ">
        <FontAwesomeIcon
          className=" hidden md:block m-auto text-blue-300 hover:text-neutral-50 "
          height={30}
          icon={faTruck}
        />
        <div>
      ...
      <div>
        ...
        <nav className="flex flex-col space-y-3 p-3">
          <NavLink
            href="/"
            text="Home"
            styles={'text-neutral-400 hover:text-blue-400'}
          />
          <NavLink
            href="/products"
            text="Products"
      ...
      <div>
        ...
        <nav className="flex flex-col space-y-3 p-3  ">
          ...
          <div className="px-5 grid justify-items-start  grid-flow-col w-52">
            <FontAwesomeIcon
              className="m-auto text-blue-400 hover:animate-scale hover:text-neutral-50"
              height={25}
              icon={faTwitter}
            />
            <FontAwesomeIcon
        ...
        <div className="flex flex-col space-y-5">
          ...
          <form className="w-full max-w-sm">
            <div className="flex items-center border-b border-blue-400 py-2">
              ...
              <button
                className="flex-shrink-0 border-transparent border-4 text-blue-400 hover:text-blue-700 text-sm py-1 px-2 rounded"
                type="button"
              >
                Cancel
              </button>
